      ...
      , q = l.BufferedBlockAlgorithm = t.extend({
        ...
        mY5d: function(a) {
            var c = this.i2x
              ...
              , k = this.blockSize
              , b = j / (4 * k)
              , b = a ? u.ceil(b) : u.max((b | 0) - this.Ri6c, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
    ...
    var p = CryptoJS
      ...
      , v = d.Cipher = t.extend({
        ...
        createDecryptor: function(e, a) {
            return this.create(this.buX3x, e, a)
        },
        init: function(e, a, b) {
...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        me5j: function() {
            for (var a = this.J2x, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.Za7T = d + 6) + 1), e = this.bvd3x = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        encryptBlock: function(a, b) {
            this.EG0x(a, b, this.bvd3x, t, r, w, v, l)
        },
        decryptBlock: function(a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.EG0x(a, c, this.bve3x, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        },
        EG0x: function(a, b, c, d, e, j, l, f) {
            for (var m = this.Za7T, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function Single(id) {
    var d =  {"ids":[id],"level":"lossless","encodeType":"flac","csrf_token":""};
    var e = "010001";
    ...
    var bKC2x = asrsea(JSON.stringify(d), e, f,g);
    return bKC2x
}

function All(name){
    var d =  {"hlpretag":"<span class=\"s-fc7\">","hlposttag":"</span>","s":name,"type":"1","offset":"0","total":"true","limit":"30","csrf_token":""}
    var e = "010001";
    var f = "";
    var g = "0CoJUm6Qyw8W8jud";
...
function lyric(id){
    var d = {"id":id,"lv":-1,"tv":-1,"csrf_token":"3f4db6940cf8b2e74549b5878fb8d3dc"};
    var e = "010001";
    var f = "";
    var g = "0CoJUm6Qyw8W8jud";
